...
ggplot(tornado_only_2020_2024_clean_dataframe, aes(x = TOR_F_SCALE, fill = TOR_F_SCALE)) +
  ...
  labs(title = "Tornado Frequency by EF Scale (2020–2025)",
       x = "Tornado EF Score",
       y = "Count",
       fill = "EF Scale", 
       tag = "Figure 6",
...
ggplot(world) +
  ...
  labs(title = "EF4 Tornadoes and Sharks of the United States",
       ...
       y = "Latitude",
       tag = "Figure 7",
       caption = "Only the Southeast Coast seems to any counts of these tornadoes.")
```
...
second_observed_proportion <- 31/3831 ; second_observed_proportion
...
boot.hist<-ggplot(bootstrap_proportions, aes(stat)) + geom_histogram(binwidth = 0.001) +
  ...
  labs(title = "Histogram of Bootstrapped Proportion of EF4 and EF5 Tornadoes",
       ...
       y = "Frequency", 
       tag = "Figure 9",
       caption = "Assuming perfect conditions, the chance that an EF4 or higher forms is on average 0.81%.") + 
